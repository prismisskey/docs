...
以下は当サーバーのルール全てを要約した内容ではないため、必ず全文の一読をお願いします。

### 禁止事項

- 日本における国内法の規制する範囲、及び一般的な常識を逸脱した行為
- 自殺、自傷行為等を思わせる投稿、グロテスクな画像及び映像、他ユーザーに対する誹謗中傷及びそれを想起させる投稿
- 誹謗中傷及び暴力的内容の投稿
- 犯罪行為の示唆、教唆、幇助も含まれます。
  - 投稿者の他に利用者の目に入る環境であれば投稿範囲の如何に関わらず禁止します。
- 実写でのアダルト、暴力的、猟奇的内容の投稿
- 他者に危害を及ぼすまたはその可能性のある内容の投稿
- 政治、宗教等の宣伝活動及び勧誘活動
- 全ての分野における差別行為及びハラスメント行為
- 想定される範囲を超えた絵文字の使用
  - この禁止事項に明示される内容に抵触する場合、悪意の有無に関わらず禁止します。
  - MFM による装飾も含まれます。
- 法令等によって規制されている物品や団体等に関する投稿
  - 創作物であると明記した上で、創作の内容として投稿することはこの限りではありません。
- 他者の人権及び知的財産権を侵害する行為
- 過度な自治行為
  - ユーザーから他ユーザーへの行動の強要も含まれます。
  - DM での議論はこの限りではありません。
- スパム行為
- 処罰の回避
  - 異議申し立て、もしくは運営の対処をお待ちください。
- 悪質ななりすまし行為
- 禁止行為を助長する投稿
- その他運営によって不適切であると判断される場合

以上の内容は補足によって説明される例外を除き、DM においても適応されるものとします。
...
悪い例：彩度の高い 速度が早い 
<img alt="bad-gaming.gif" height="64" src="/bad-gaming.gif" width="64"/>
