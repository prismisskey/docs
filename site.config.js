const CONFIG = {
  ...
  seo: {
    keywords: ["Blog", "Website", "Notion","mattyatea","misskey","cloudflare","morethan-log","vercel","ミスキー","みすきー","mattyaski","まっちゃてぃー","抹茶ティー","マニュアル","インストール","構築","インスタンス","instance","まっちゃすきー","mattyacocacora"."Misskey","建て方","v13",],
  },
